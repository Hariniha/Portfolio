        ...
        {particles.map((particle, index) => (
          <div
            ...
            style={{
              ...
              boxShadow: `0 0 ${particle.size * 2}px #a855f7`,
            }}
          />
        ))}
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 justify-center">
          {contactInfo.map((info) => (
            <a
              key={info.label}
              href={info.href}
              className="flex flex-col items-center text-center p-6 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-300 hover:scale-105 group"
            >
              <div className="p-4 rounded-full mb-4 bg-purple-500/20">
