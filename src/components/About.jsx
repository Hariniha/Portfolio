    ...
    <section id="about" className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {skills.map((skill, index) => (
            <div
              key={skill.title}
              className="p-6 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="w-12 h-12 rounded-lg mb-4 flex items-center justify-center bg-purple-500/20">
